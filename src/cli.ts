...
/*
 * nativets CLI
 *   nativets build <file.ts> [-o out] [--target host|ios|android|windows]
...
function usage(): never {
  console.error("usage: nativets <build|run|emit|coverage> <file.ts> [-o out] [--target host|ios|ios-sim|android|windows] [--static]");
  process.exit(2);
}
