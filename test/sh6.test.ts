...
const BASELINE: Record<string, { rung: Rung; code: string; blame: string }> = {
  ...
  "ast.ts": { rung: 0, code: "NT1003", blame: "self" },
  ...
  "parser.ts": { rung: 0, code: "NT1003", blame: "ast.ts" },
  ...
  "checker.ts": { rung: 0, code: "NT1003", blame: "ast.ts" },
  ...
  "codegen.ts": { rung: 0, code: "NT1003", blame: "ast.ts" },
  ...
  "coverage.ts": { rung: 0, code: "NT1003", blame: "ast.ts" },
  ...
  "ownership.ts": { rung: 0, code: "NT1003", blame: "ast.ts" },
  "driver.ts": { rung: 0, code: "NT1003", blame: "ast.ts" },
  ...
  "cli.ts": { rung: 0, code: "NT1003", blame: "ast.ts" },
  ...
  "modules.ts": { rung: 0, code: "NT1003", blame: "ast.ts" },
...
const STAGE1_BASELINE: { rung: Rung; code: string } = { rung: 0, code: "NT1003" };
...
describe("SH6: differential self-compilation (bun-run compiler is the oracle)", () => {
  ...
  test("a nativets-compiled compiler emits IR identical to the bun-run compiler", async () => {
    ...
    if (m.rung < 3) {
      ...
      expect(m.error).toContain("function values");
