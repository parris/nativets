...
const BASELINE: Record<string, { rung: Rung; code: string; blame: string }> = {
  ...
  "parser.ts": { rung: 0, code: "NT1011", blame: "self" },
  ...
  "coverage.ts": { rung: 0, code: "NT1011", blame: "parser.ts" },
  ...
  "driver.ts": { rung: 0, code: "NT1011", blame: "parser.ts" },
  ...
  "cli.ts": { rung: 0, code: "NT1011", blame: "parser.ts" },
  ...
  "modules.ts": { rung: 0, code: "NT1011", blame: "parser.ts" },
...
describe("SH6: differential self-compilation (bun-run compiler is the oracle)", () => {
  ...
  test("a nativets-compiled compiler emits IR identical to the bun-run compiler", async () => {
    ...
    if (m.rung < 3) {
      ...
      expect(m.error).toContain("for-of over");
