...
const BASELINE: Record<string, { rung: Rung; code: string; blame: string }> = {
  ...
  // PARSER.TS IS CHECKER-CLEAN — 0 of 118 functions refused, from a long chain at the
...
// NT1002 -> NT1011: the monomorphizer's `structuredClone` was deep-copying a tree that
...
// NT1606 -> NT1002: the definite-assignment pass is through. Its escape lists became
// three MARKED arrays of name snapshots (a `Set<string>[]` has no representation), its
// clear-and-refill became a difference, and its second reflective walker is typed. Behind
// it: a method call on `unknown`, in one of the ten walkers still to go.
